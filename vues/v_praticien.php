...
<form action ="index.php?uc=GestionPraticiens&action=supprimer" method="POST">
		...
		<input type="submit" value="Ajouter"/><img src="images/ajouter.jpg" width="100" height="35" style="height: 35px;border: 1px solid;border-radius: 10px; margin-bottom: 10px"/>		
		</div>		  
	  	<tr>
		   	<th>Sélection</th>
